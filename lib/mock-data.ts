...
export const merchants: Merchant[] = [
  {
    id: 'merchant-1',
    userId: 'user-2',
    businessName: 'Cervejaria Artesanal do Beco',
    category: 'Bar & Cervejaria',
    description: 'A melhor cerveja artesanal da região com ambiente descontraído e música ao vivo aos finais de semana.',
  ...
  },
  {
    ...
    description: 'Espaço dedicado à arte contemporânea brasileira com exposições rotativas e workshops.',
    logoUrl: 'https://images.unsplash.com/photo-1531243269054-5ebf6f34081e?w=200&h=200&fit=crop',
  ...
  },
  {
    ...
    description: 'Café especial combinado com espaço de coworking. Ideal para freelancers e nômades digitais.',
  ...
  },
  {
    ...
    description: 'O melhor da comida de rua reunido em um só lugar. Diversos food trucks e área kids.',
...
export const events: Event[] = [
  {
    ...
    description: 'Uma noite especial com os melhores músicos de jazz da cidade. Entrada gratuita para os primeiros 50 clientes.',
    latitude: -23.5505,
    longitude: -46.6333,
  ...
  },
  {
    ...
    description: 'Mostra coletiva com 15 artistas brasileiros contemporâneos. Vernissage com coquetel de abertura.',
    latitude: -23.5614,
    longitude: -46.6558,
  ...
  },
  {
    ...
    description: 'Aprenda técnicas profissionais de latte art com nosso barista campeão. Inclui certificado.',
    latitude: -23.5629,
    longitude: -46.6698,
  ...
  },
  {
    ...
    description: 'Edição especial com pratos quentes e confortantes. Mais de 20 food trucks participantes.',
    latitude: -23.5667,
    longitude: -46.6876,
  ...
  },
  {
    ...
    description: 'Os melhores comediantes de São Paulo em uma noite de muitas risadas. Open bar de chope artesanal.',
    latitude: -23.5505,
    longitude: -46.6333,
    merchantId: 'merchant-1',
  ...
  },
  {
    ...
    description: 'Apoie artesãos locais! Mais de 50 expositores com produtos únicos e autorais.',
    latitude: -23.5614,
    longitude: -46.6558,
    merchantId: 'merchant-2',
  ...
  },
  {
    ...
    description: 'Prove cafés de diferentes regiões do Brasil. Inclui explicação sobre métodos de preparo.',
    latitude: -23.5629,
    longitude: -46.6698,
    merchantId: 'merchant-3',
    startsAt: '2024-12-29T15:00:00Z',
    endsAt: '2024-12-29T18:00:00Z',
    imageUrl: 'https://images.unsplash.com/photo-1442512595331-e89e73853f31?w=800&h=500&fit=crop',
    category: 'Gastronomia',
    price: 45,
    attendees: 18,
    maxAttendees: 25
  },
  {
    ...
    description: 'Celebre a virada do ano com música ao vivo, comida incrível e fogos de artifício!',
    latitude: -23.5667,
    longitude: -46.6876,
    merchantId: 'merchant-4',
    startsAt: '2024-12-31T20:00:00Z',
    endsAt: '2025-01-01T04:00:00Z',
    imageUrl: 'https://images.unsplash.com/photo-1467810563316-b5476525c0f9?w=800&h=500&fit=crop',
    category: 'Festa',
    price: 200,
    isLive: false,
    attendees: 789,
...
export function getUserEvents(userId: string): (UserEvent & { event: Event })[] {
  return userEvents
...
export function getMetricsByMerchant(merchantId: string): MerchantMetrics | undefined {
